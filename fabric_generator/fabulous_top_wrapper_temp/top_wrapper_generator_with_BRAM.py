...
def main(argv):
    ...
    wrapper_top_str = wrapper_top_str.replace("[XXX:0] FrameRegister", '['+str(NumberOfRows*FrameBitsPerRow)+'-1:0] FrameRegister')
    wrapper_top_str = wrapper_top_str.replace("[XXX:0] FrameSelect", '['+str(NumberOfCols*MaxFramesPerCol)+'-1:0] FrameSelect')
    wrapper_top_str = wrapper_top_str.replace("[32-1:0] I_top", '['+str(NumberOfRows*4)+'-1:0] I_top')
    ...
    wrapper_top_str = wrapper_top_str.replace("localparam MaxFramesPerCol = 20", "localparam MaxFramesPerCol = "+str(MaxFramesPerCol))
    ...
    wrapper_top_str+='\t.OutputEnable(OutputEnable),\n'
